        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter :
                try:
                    ...
                    print("[DEBUG] Exception in densification")
                    print("[DEBUG] max_radii2D shape:", gaussians.max_radii2D.shape, gaussians.max_radii2D.device)
                    print("[DEBUG] radii shape:", radii.shape, radii.device)
                    print("[DEBUG] visibility_filter shape:", visibility_filter.shape, visibility_filter.device)
                    print("[DEBUG] visibility_filter sum:", visibility_filter.sum().item())
                    raise Exception("[DEBUG] Exception in densification")
